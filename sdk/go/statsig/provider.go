...
type Provider struct {
	...
	ConsoleApiKey pulumi.StringPtrOutput `pulumi:"consoleApiKey"`
}
...
func NewProvider(ctx *pulumi.Context,
	...
	if args.ConsoleApiKey != nil {
		args.ConsoleApiKey = pulumi.ToSecret(args.ConsoleApiKey).(pulumi.StringPtrInput)
	}
	...
	err := ctx.RegisterResource("pulumi:providers:statsig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type providerArgs struct {
	// A Statsig Console API Key
	ConsoleApiKey *string `pulumi:"consoleApiKey"`
}

// The set of arguments for constructing a Provider resource.
type ProviderArgs struct {
	// A Statsig Console API Key
	ConsoleApiKey pulumi.StringPtrInput
}
...
func (r *Provider) TerraformConfig(ctx *pulumi.Context) (ProviderTerraformConfigResultOutput, error) {
	out, err := ctx.Call("pulumi:providers:statsig/terraformConfig", nil, ProviderTerraformConfigResultOutput{}, r)
	if err != nil {
...
// A Statsig Console API Key
func (o ProviderOutput) ConsoleApiKey() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Provider) pulumi.StringPtrOutput { return v.ConsoleApiKey }).(pulumi.StringPtrOutput)
}
