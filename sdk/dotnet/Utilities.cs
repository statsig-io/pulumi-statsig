...
namespace Pulumi.Statsig
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Statsig.version.txt");
    ...
    internal sealed class StatsigResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public StatsigResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
