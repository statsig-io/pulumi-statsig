...
namespace Pulumi.Statsig.Inputs
{
    ...
    public sealed class MetricWarehouseNativeGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("criterias")]
        private InputList<Inputs.MetricWarehouseNativeCriteriaGetArgs>? _criterias;

        /// <summary>
        /// Filtering criteria for the metric source
        /// </summary>
        public InputList<Inputs.MetricWarehouseNativeCriteriaGetArgs> Criterias
        {
            get => _criterias ?? (_criterias = new InputList<Inputs.MetricWarehouseNativeCriteriaGetArgs>());
        ...
        private InputList<Inputs.MetricWarehouseNativeDenominatorCriteriaGetArgs>? _denominatorCriterias;

        /// <summary>
        /// Filtering criteria for the denominator metric source, if this metric is a ratio
        /// </summary>
        public InputList<Inputs.MetricWarehouseNativeDenominatorCriteriaGetArgs> DenominatorCriterias
        {
            get => _denominatorCriterias ?? (_denominatorCriterias = new InputList<Inputs.MetricWarehouseNativeDenominatorCriteriaGetArgs>());
        ...
        [Input("funnelEvents")]
        private InputList<Inputs.MetricWarehouseNativeFunnelEventGetArgs>? _funnelEvents;

        /// <summary>
        /// List of funnel events with associated criteria and identifiers.
        /// </summary>
        public InputList<Inputs.MetricWarehouseNativeFunnelEventGetArgs> FunnelEvents
        {
            get => _funnelEvents ?? (_funnelEvents = new InputList<Inputs.MetricWarehouseNativeFunnelEventGetArgs>());
        ...
        public MetricWarehouseNativeGetArgs()
        {
        }
        public static new MetricWarehouseNativeGetArgs Empty => new MetricWarehouseNativeGetArgs();
    }
}
