module github.com/statsig-io/pulumi-statsig/provider
...
replace github.com/statsig-io/terraform-provider-statsig/shim => ./shim

require (
	github.com/pulumi/pulumi-terraform-bridge/v3 v3.108.0
	github.com/pulumi/pulumi/pkg/v3 v3.166.0
	github.com/statsig-io/terraform-provider-statsig/shim v0.0.0
)
...
require (
	...
	github.com/statsig-io/terraform-provider-statsig v1.0.1-0.20250531214556-e170221def4d // indirect
